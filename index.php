...
<body>
    <a href="#" class="btn-flotante" id="btnCarrito">Car <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <a href="#" class="nav-link text-info" category="all">all</a>
                        <?php
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">MercaOnline</h1>
                <p class="lead fw-normal text-white-50 mb-0">a place to find everything...</p>
            </div>
        </div>
    </header>
    <section class="py-5">
